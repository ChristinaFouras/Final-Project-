...
date: "2024-03-14"
>>>>>>> 07859d69cbb0e648bfdd886899271cf3d569bf7f
output:
...
=======
- What have we learnt 
  - Averages total interactions for those who particpated in app features
- Circling back
- Drawbacks 
Dating apps are continuously updating themselves trying new strategies to engage more and create new revenue streams. Our deep dive into their data attempted to analyse whether the creation of new features has been effective. We can see that the only feature that you have to pay for with real money does seem to be doing what its supposed to.Those who are willing to shill out a little extra, will have their profile promoted in an effective manner. The next most effective way was to verify your profile so it would be shown in an effective way to draw more interest into your profile, ensuring that you are a real person. A drawback to this dataset is that it ends after the participants went on a first date. Data on the longevity of the relationship, if the participants on the first date entered a relationship together, would provide more insight onto the effectiveness of the app in pairing people together. Considering that dating apps are a primary source of introduction between people looking for relationships the effectiveness of an app, Lovoo or any dating app, would be important information to know, out of interest and for the general public when they choose what app they download. 
