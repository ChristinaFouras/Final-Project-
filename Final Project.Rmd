...
dataset1 %>%
  ...
  ylab("Number of interactions")+
  ggtitle("Number of user interactions based Highlighted Feature")
...
dataset1 %>%
  ...
  ylab("Number of interactions")+
  ggtitle("Number of user interactions based Verified Feature")
...
dataset1 %>%
  ...
  xlab("VIP Feature")+
  ylab("Number of interactions")+
  ggtitle("Number of user interactions based VIP Feature")
...
dataset1 %>%
  ...
  xlab("User features")+
  ylab("Number of interactions")+
  ggtitle("Comparison of different User Features")

#I changed the y limit here just so it was a little bit more clear 
```
